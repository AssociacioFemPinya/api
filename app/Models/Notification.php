...
#[ApiResource(
    ...
    operations: [
        new Get(
            provider: NotificationsStateProvider::class,
        ),
        new GetCollection(
            provider: NotificationsStateProvider::class,
        ),
...
class Notification extends Model
{
    ...
    public function render(?Casteller $casteller = null, string $template_type = 'app'): string
    {
    ...
    {
        return view('notifications.templates.'.$this->getTemplate().'.app', array_merge([
            'notification' => $this,
            'casteller' => null,
        ], unserialize($this->getData())))->render();
    }
